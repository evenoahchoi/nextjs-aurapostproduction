                    ...
                    <div className="bg-white shadow-lg rounded-lg p-8">
                        ...
                        <div className="prose prose-lg max-w-none">
                            ...
                            <section className="mb-8">
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg">
                                    <div className="text-gray-700 space-y-2">
                                        ...
                                        <p>2. <strong>&apos;이용자&apos;</strong>란 본 약관에 동의하고 회사가 제공하는 서비스를 이용하는 자를 말합니다. 별도의 회원가입 없이도 서비스를 이용할 수 있으며, 앱 설치 시 자동으로 이용자로 간주됩니다.</p>
                            ...
                            <section className="mb-8">
                                ...
                                <div className="text-gray-700 leading-relaxed space-y-2">
                                    <p>1. 마이핑(MYPING) 서비스는 <strong>별도의 회원가입이나 로그인 절차 없이</strong> 앱을 설치하고 실행하는 것으로 서비스 이용이 시작됩니다.</p>
                                    <p>2. 이용자는 앱을 설치하고 최초 실행함으로써 본 이용약관 및 개인정보처리방침에 동의한 것으로 간주됩니다.</p>
                                    <p>3. 만 14세 미만의 이용자는 법정대리인의 동의를 받은 경우에 한해 서비스를 이용할 수 있습니다.</p>
                                </div>
                            </section>
                            ...
                            <section className="mb-8">
                                ...
                                <div className="text-gray-700 leading-relaxed space-y-2">
                                    <p>1. 회사는 기본 서비스를 무료로 제공하며, 일부 프리미엄 기능에 대해서는 인앱 결제(In-App Purchase) 방식으로 유료 서비스를 제공합니다.</p>
                                    <p>2. 유료 서비스의 결제는 이용자가 사용하는 기기의 앱 마켓(Google Play Store, Apple App Store)의 결제 시스템을 통해 처리됩니다.</p>
                                    <p>3. 결제된 유료 서비스는 별도의 환불 정책에 따라 처리되며, 환불 관련 사항은 각 앱 마켓의 환불 정책을 따릅니다.</p>
                                    <p>4. 회사는 유료 서비스의 가격, 내용을 변경할 경우 사전에 이용자에게 고지합니다.</p>
                                </div>
                            </section>
